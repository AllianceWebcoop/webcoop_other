...
if __name__=="__main__":
    ...
    load_file(conn, "wc.member", "member.csv", logger)
    #load_file(conn, "wc.member", "member.csv1", logger)
    #load_file(conn, "wc.member", "member.csv2", logger)
    #load_file(conn, "wc.member", "member.csv3", logger)
    #load_file(conn, "wc.member", "member.csv4", logger)
