...
if __name__=="__main__":
    ...
    load_file(conn, "wc.account", "account.timedeposit.csv", logger)
#    load_file(conn, "wc.account", "account.timedeposit.csv1", logger)  
#    load_file(conn, "wc.account", "account.timedeposit.csv2", logger)  
#    load_file(conn, "wc.account", "account.timedeposit.csv3", logger)   
