...
if __name__=="__main__":
    ...
    #import journal info
    try :
        logger.info("start import loan balance forward")
        load_file(conn, "wc.loan.detail", "loan.detail.csv", logger)
        load_file(conn, "wc.loan.payment", "loan.payment.csv", logger)
        load_file(conn, "wc.loan.payment.distribution", "loan.payment.distribution.csv", logger)
    except Exception ,e:
