...
if __name__=="__main__":
    ...
    #import journal info
    logger.info("start import address")
    load_file(conn, "wc.province", "province_new.csv", logger)
    load_file(conn, "wc.municipal", "municipal_new.csv", logger)
    load_file(conn, "wc.barangay", "barangay_new.csv", logger)
