...
if __name__=="__main__":
    ...
    load_file(conn, "wc.account.transaction", "account.transaction.dep.csv", logger)    
#    load_file(conn, "wc.account.transaction", "account.transaction.dep.csv1", logger)    
#    load_file(conn, "wc.account.transaction", "account.transaction.dep.csv2", logger)    
#    load_file(conn, "wc.account.transaction", "account.transaction.dep.csv3", logger)    
