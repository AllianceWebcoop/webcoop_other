...
if __name__=="__main__":
    ...
    load_file(conn, "wc.account", "saving.bf.csv", logger)
    load_file(conn, "wc.account.transaction", "saving.bf.transaction.csv", logger)
    
    #load_file(conn, "wc.account", "saving.bf.csv1", logger)
    #load_file(conn, "wc.account.transaction", "saving.bf.transaction.csv1", logger)
      
    #load_file(conn, "wc.account", "saving.bf.csv2", logger)
    #load_file(conn, "wc.account.transaction", "saving.bf.transaction.csv2", logger)
