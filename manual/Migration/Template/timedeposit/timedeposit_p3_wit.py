...
if __name__=="__main__":
    ...
    load_file(conn, "wc.account.transaction", "account.transaction.wit.csv", logger)    
#    load_file(conn, "wc.account.transaction", "account.transaction.wit.csv1", logger)    
#    load_file(conn, "wc.account.transaction", "account.transaction.wit.csv2", logger)    
#    load_file(conn, "wc.account.transaction", "account.transaction.wit.csv3", logger)    
